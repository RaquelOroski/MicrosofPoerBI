...
# Convertendo a variável para o tipo fator com faixa etÃ¡ria
...
# Total de inadimplentes versus nÃ£o-inadimplentes
?table
...
# Plot da distribuiçãoo usando ggplot2
...
# Importância das variáveis preditoras para as previsÃµes
...
# Construindo a terceira versã do modelo apenas com as variáveis mais importantes
...
# Previsõees com novos dados de 3 clientes
